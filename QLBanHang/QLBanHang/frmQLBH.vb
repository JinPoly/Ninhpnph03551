Public Class frmQLBH
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        If _DBAccess.ExecuteNoneQuery(sqlQuery) Then
            MessageBox.Show("Xóa thành công!", "(-_-)", MessageBoxButtons.OK)
            LoadKH()
        Else
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        Dim EditKH As New frmKH(True)
        With Me.dgvKH
            EditKH.txtMaKH.Text = .Rows(.CurrentCell.RowIndex).Cells("MaKH").Value
            EditKH.txtTen.Text = .Rows(.CurrentCell.RowIndex).Cells("TenKH").Value
